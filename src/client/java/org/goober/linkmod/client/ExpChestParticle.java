...
public class ExpChestParticle extends SpriteBillboardParticle {
    private final double startX;
    private final double startY;
    private final double startZ;

    protected ExpChestParticle(ClientWorld clientWorld, double d, double e, double f, double g, double h, double i) {
    ...
    public static class Factory implements ParticleFactory<SimpleParticleType> {
        ...
        public Particle createParticle(SimpleParticleType particleType, ClientWorld world, double x, double y, double z, double velocityX, double velocityY, double velocityZ) {
            ExpChestParticle particle = new ExpChestParticle(world, x, y, z, velocityX, velocityY, velocityZ);
