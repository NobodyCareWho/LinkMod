...
public class pillager - Converted<T extends Entity> extends EntityModel<T> {
	// This layer location should be baked with EntityRendererProvider.Context in the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("modid", "pillager_- converted"), "main");
	...
	public pillager - Converted(ModelPart root) {
	...
	public static LayerDefinition createBodyLayer() {
		...
		.texOffs(32, 14).addBox(-4.0F, -5.0F, -5.0F, 8.0F, 3.0F, 1.0F, new CubeDeformation(0.0F))
		.texOffs(28, 0).addBox(-4.0F, -6.0F, -8.0F, 8.0F, 0.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 0.0F, 0.0F));
