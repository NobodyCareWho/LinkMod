...
public class Bullets {
    ...
    static {
        ...
        register("breezeshot", new BulletType("Breezeshot", 1.0f, 0xFF444444, Set.of("shotgun_shells"), 0, 3,BulletSoundProfile.get("breeze"),ParticleProfile.get("breeze"), bulletFactory));
        register("blazeshot", new BulletType("Blazeshot", 0.2f, 0xFF444444, Set.of("shotgun_shells"), 12, 0.5f,BulletSoundProfile.get("blaze"),ParticleProfile.get("standard"), sparkbulletFactory));
