...
public class Bullets {
    ...
    static {
        ...
        register("freezeshot", new BulletType("Freezeshot",true ,  0.2f, 0xFF444444, Set.of("shotgun_shells"), 8, 1, 0.7f, 1.5f,2,1,"shotgunshellempty", BulletSoundProfile.get("standard"),ParticleProfile.get("freeze"), icebulletFactory));
        ...
        register("thumpershell", new BulletType("Thumper Shell",false ,  0.6f, 0xFF444444, Set.of("grenade_shells"), 8, 3f, 1, 1.2f, 6, 1, "grenadeshellempty", BulletSoundProfile.get("goofyahh"),ParticleProfile.get("goofyahh"), bulletFactory));
