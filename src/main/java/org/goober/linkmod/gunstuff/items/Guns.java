...
public class Guns {
    ...
    static {
        ...
        register("autorifle", new GunType("Auto Rifle", 12.3f, 5.8f, 4, 30, 1.2f, 13, 12, 0.7f, 1.4f, 2.4f, Set.of("rifle_ammo"), ShellEjectionMode.TO_WORLD, 0.14f,GunSoundProfile.get("autorifle")));
    ...
    public record GunType(
        ...
        public boolean acceptsBullet(BulletItem bulletItem) {
            ...
            // for non-grenade-launcher guns, reject grenades
