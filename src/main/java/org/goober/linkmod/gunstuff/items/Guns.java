...
public class Guns {
    ...
    static {
        ...
        register("shotgun", new GunType("D.B. Shotgun", 7.5f, 2.5f, 2, 2, 7f, 3f, 2f, 3f, 1,2.0f, Set.of("shotgun_shells"), ShellEjectionMode.TO_BUNDLE, 0.6f,GunSoundProfile.get("dbshotgun")));
        register("revolver", new GunType("Revolver", 9.2f, 8.0f, 3, 6, 0, 9f, 5, 1.6f, 1, 2.0f, Set.of("rifle_ammo"), ShellEjectionMode.TO_BUNDLE, 0,GunSoundProfile.get("revolver")));
        ...
        register("grenadelauncher", new GunType("Grenade Launcher", 15.5f, 1.0f, 14, 1, 1, 0, 0, 0, 0, 2.0f, Set.of("grenade_shells"), ShellEjectionMode.TO_BUNDLE, 0.4f,GunSoundProfile.get("dbshotgun")));
