...
public class Guns {
    ...
    static {
        ...
        register("ejectorpistol", new GunType("Ejector Pistol", 7.5f, 5.6f, 8, 8, 1.4f, 4, 5, 0.7f, 2.0f, Set.of("rifle_ammo"), ShellEjectionMode.TO_WORLD, 0,GunSoundProfile.get("autopistol")));
        ...
        register("pumpsg", new GunType("Pump Shotgun", 6.5f, 4.0f, 14, 5, 5.5f, 3f, 5f, 0.5f, 2.0f, Set.of("shotgun_shells"),  ShellEjectionMode.TO_WORLD, 0.4f,GunSoundProfile.get("pumpshotgun")));
    ...
    public record GunType(
        ...
        float bloomDecayRate, // bloom units recovered per second
