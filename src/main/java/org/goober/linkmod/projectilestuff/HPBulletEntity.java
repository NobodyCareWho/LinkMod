...
public class HPBulletEntity extends PersistentProjectileEntity implements DamageableProjectile {
    ...
    public HPBulletEntity(EntityType<? extends PersistentProjectileEntity> entityType, World world) {
        super(entityType, world);
        this.bulletStack = ItemStack.EMPTY;
        this.setNoGravity(true);
    }

    public HPBulletEntity(World world, LivingEntity owner, ItemStack bulletStack) {
